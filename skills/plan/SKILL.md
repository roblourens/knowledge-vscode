...
Create the session directory: `mkdir -p "$KNOWLEDGE_CHECKOUT/plan/$SESSION_SLUG"`.

### 6. Write the plan

Create `$KNOWLEDGE_CHECKOUT/plan/$SESSION_SLUG/plan.md`:
...
Create `$KNOWLEDGE_CHECKOUT/plan/$SESSION_SLUG/tasks.md`:
